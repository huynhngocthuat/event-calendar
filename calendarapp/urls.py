...
urlpatterns = [
    ...
    path("event/<int:pk>/remove", views.EventDelete.as_view(), name="remove_event",),
    path("add_eventmember/<int:event_id>", views.add_eventmember, name="add_eventmember"),
    path("eventmember/<int:pk>/remove", views.EventMemberDeleteView.as_view(), name="remove_eventmember",),
